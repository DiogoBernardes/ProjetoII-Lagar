...
public class clientController {
    ...
    public void removeButtonOnAction(ActionEvent event) throws IOException {
        Entidade selectedEntidade = clientView.getSelectionModel().getSelectedItem();
        if (selectedEntidade != null) {
            ...
            if (result.get() == okButton) {
                ...
                clientView.getItems().remove(selectedEntidade);
            } else {
                alert.close();
            }
        }else {
    ...
    public void editButtonOnAction(ActionEvent event) throws IOException {
        ...
        if (selectedEntidade != null) {
            ...
            controller.setEntidade(clientView.getSelectionModel().getSelectedItem());
