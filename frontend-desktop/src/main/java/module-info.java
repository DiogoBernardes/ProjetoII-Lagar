module Projeto.Lagar.frontend.desktop.main {
    ...
    opens IPVC.Gestor to javafx.fxml;
    ...
    opens IPVC.Admin.Packaging to javafx.fxml;
    opens IPVC.Admin.Employees to javafx.fxml;
    opens IPVC.Admin.Sales to javafx.fxml;
